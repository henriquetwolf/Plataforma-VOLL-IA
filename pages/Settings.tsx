...
import { Settings as SettingsIcon, Users, Activity, Newspaper, Save, CheckCircle } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
        ...
        <div className="p-6 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50 flex items-center justify-between">
            ...
            <Button onClick={handleSave} isLoading={saving} className="bg-brand-600 hover:bg-brand-700 text-white shadow-lg shadow-brand-200">
