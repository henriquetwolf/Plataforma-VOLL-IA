...
export const FinancialAgent: React.FC = () => {
    ...
    // ... handleLoad, handleDelete, handleDownloadPDF (same as before) ...
                            ...
                            <div className="mb-6">
                                <div className="flex justify-between items-center mb-4 border-b border-slate-100 pb-2">
                                    <h3 className="font-bold text-xl flex items-center gap-2">
                                        <Sparkles className="h-5 w-5 text-purple-600" /> IA Analysis
                                    </h3>
                                    <Button size="sm" onClick={handleGenerateAnalysis} disabled={isAiLoading || results.length === 0} className="bg-purple-600 hover:bg-purple-700 text-white">
                                        {isAiLoading ? <Loader2 className="animate-spin h-3 w-3"/> : t('generate_btn')}
                                    </Button>
                                </div>
