      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link 
            ...
            className="group relative overflow-hidden bg-gradient-to-br from-white to-purple-50/30 p-6 rounded-xl shadow-sm border border-purple-100 hover:border-purple-400 hover:shadow-lg transition-all"
          >
            <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
              <Target size={120} />
            </div>
            ...
            <div className="relative z-10">
              ...
              <h3 className="font-bold text-lg text-slate-900 mb-2">Criador de Missão</h3>
              <p className="text-sm text-slate-600 mb-6 leading-relaxed">
                Especialista em branding. Gera opções de missão personalizadas com base no foco do seu estúdio.
              </p>
              
              <span className="inline-flex items-center text-sm font-bold text-purple-700 group-hover:gap-2 transition-all">
                Acessar Agente <ArrowRight className="h-4 w-4 ml-1" />
              </span>
            </div>
          </Link>
